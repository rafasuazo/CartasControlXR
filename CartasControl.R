...
cartasX_R <- function(data) {
  ...
  patron5 <- function(valores, LCS_ZC, LCI_ZC){
    ...
    #Quince puntos consecutivos en la zona C, arriba o abajo de la l�nea central
    saltos = longitud - 14
    for(i in 1:saltos) {
      front = i + 14
      ...
      if(all(valores[i:front] < LCS_ZC & valores[i:front] > LCI_ZC)){
        ...
        patronFueraControl <<- "Patr�n 5: Falta de variabilidad"
        break
      }
    }
  ...
  patron4 <- function(valores, LCS_ZC, LCI_ZC) {
    ...
    #Ocho puntos consecutivos en ambos lados de la l�nea central con ninguno en la zona C
    saltos = longitud - 7
    for(i in 1:saltos) {
      front = i + 7
      ...
      if(all(valores[i:front] > LCS_ZC | valores[i:front] < LCI_ZC)){
        ...
        patronFueraControl <<- "Patr�n 4: Mucha variabilidad"
        break
      }
    }
  ...
  patron2 <- function(valores) {
    ...
    #Seis o m�s puntos consecutivos ascendentes o decendentes
    saltos = longitud - 5
    ...
    for(i in 1:saltos) {
      ...
      if(all(diff(valores[i:front]) > 0) | all(diff(valores[i:front]) < 0)){
        ...
        patronFueraControl <<- "Patr�n 2: Regla 1 \nTendencias en el nivel del proceso"
        break
      }
    }
    ...
    if(enControlPatron2){
      ...
      if(r > 0.5 | r < -0.5){
        ...
        enControlPatron2 <<- FALSE
        patronFueraControl <<- "Patr�n 2: Regla 2 \nTendencias en el nivel del proceso"
    ...
    if(enControlPatron1){
      for (i in 1:saltos){
        ...
        if(
          ...
          colores[i:front] = rep("red", times = 8)
          enControlPatron1 <<- FALSE
          patronFueraControl <<- "Patr�n 1: Regla 2 \nDesplazamientos o cambios en el nivel del proceso"
          break
        }
      }
    }
    
    #Al menos 10 de 11 puntos consecutivos caen de un mismo lado de la l�nea central.
    saltos = longitud - 10
    if(enControlPatron1){
      for(i in 1:saltos) {
        front = i + 10
        ...
        if(sumaPuntos == 1 | sumaPuntos == 10){
          ...
          enControlPatron1 <<- FALSE
          patronFueraControl <<- "Patr�n 1: Regla 3 \nDesplazamientos o cambios en el nivel del proceso"
          break
        }
      }
    }
    
    #Por lo menos 12 de 14 puntos consecutivos ocurren por un mismo lado de la l�nea central.
    saltos = longitud - 13
    if(enControlPatron1){
      for(i in 1:saltos) {
        front = i + 13
        ...
        if(sumaPuntos == 2 | sumaPuntos == 12){
          ...
          enControlPatron1 <<- FALSE
          patronFueraControl <<- "Patr�n 1: Regla 4 \nDesplazamientos o cambios en el nivel del proceso"
          break
        }
      }
    }
